<?php
  ...
  $conn = mysqli_connect('localhost', 'root', '', 'carecenter');
    if (!$conn) {
      ...
      if(isset($sid) And isset($sname) And isset($scontact) And isset($scnic) And isset($saddress) And isset($ssalary) And isset($sdesignation) And isset($sshift) ){
      ...
      echo "Value is Not Extracting Properly";
    }
  }
    mysqli_close($conn);
  }
